...
下級には、おなじく[ディオニュシウス²][36]{#denis2}によると、{r}権天使(プリンキパトウス){/r}、{r}天使(アンゲリ){/r}、{r}大天使(アルカンゲリ){/r}の3隊がある。
