...
date: 17-07-2017, 13:39
modified: 11-09-2017, 17:12
itempage: Article
taxonomy:
   category: [docs, ja]
metadata:
...
! この第十二章文書は、「[天の戦い][7]{#renvoi_bataille}」とも呼ばれている通り、恐ろしい戦いが起こって、大天使ミカエルが見えて来ますが、言葉より、[新共同訳][5]から引用されている本文を自分でお読みになることをお勧めします。  
