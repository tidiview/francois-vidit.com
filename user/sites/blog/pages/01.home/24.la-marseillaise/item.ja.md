...
date: 21-11-2017, 15:43
modified: 23-11-2017, 17:15
...
simplesearch:
   enabled: false
metadata:
   description: "一般に知られている翻訳に不満がありましたので、よりフランス語本文に忠実に改めて翻訳しました。独自翻訳。新しくなったラ・マルセイエーズ（La Marseillaise）翻訳を本文と対照的にし、注釈で自分の選択を説明しています。"
...
<figure id="original-text-rousi" markdown="1" style="writing-mode:initial;-webkit-writing-mode: initial;">
...
|   |   |
| 3 | 我らに[[color=#3d8b3d]対す[/color]](#note_3 "対す"){#contre}[[color=#3d8b3d]{r}僭(せん)主(しゅ){/r}政治[/color]](#note_3 "僭主政治"){#tyrannie}、 |
|   |   |
| 4 |  血まみれの旗が掲げられた、 |
|   |   |
| 5 |  血まみれの旗が掲げられた！ |
...
|   | 我らに[color=#3d8b3d]対す{r}僭(せん)主(しゅ){/r}政治[/color]、 | [color=lightgrey]フランソワ・ヴィディ訳[/color] |
</div>

<br>

[color=#3d8b3d]Contre[/color] nous の「contre」は「向かう」にならず「contre」が「対立」の意を示すことから「[対す](#contre "対す"){#note_contre}」に。

de la [color=#3d8b3d]tyrannie[/color], の「,」は次の文節との関係を示し、勝手に「の」の関係を付けることは出来ません。  
tyrannie に「暴君」という訳を当てるのは、短絡的すぎるので、ここは革命期のローマ共和政の模範的道徳思想への愛着を含む「[{r}僭(せん)主(しゅ){/r}政治](#tyrannie "僭主政治"){#note_tyrannie}」に。[color=lightgrey][&#11105;](#contre "対す")[/color]
...
## [size=30][color=#3d8b3d]第六変更・隊伍[/color][/size] {#note_11}
...
ここでは、革命の視点から、{r}僭(せん)主(しゅ){/r}政治が人間の自然状態を反することで「祖国の子」として、または自由の「市民」として許すことが出来はしません。[&#11105;](#abreuve "不純な")
...
|   | <br> |
|   |   |
| 6 | 聞こえるか[[color=#3d8b3d]戦場の[/color]](#note_6 "戦場の") |
|   |   |
