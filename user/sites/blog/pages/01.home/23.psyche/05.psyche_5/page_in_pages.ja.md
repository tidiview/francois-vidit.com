...
プシケは自分の思いがけとすっかり反対に、追い出しを食って（いまは）二重の悲しみに打ち{r}挫(ひし){/r}がれ、とぼとまたもとの道をひろって参りますうち、低まの{r}谿(たに){/r}の{r}小(お)昏(ぐら){/r}い木立のあいだに、{r}工(こう)匠(しょう){/r}の腕をつくしたお社があるのを見つけました。
